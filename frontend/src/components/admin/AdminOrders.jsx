    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="flex gap-6">
          {/* Orders table */}
          <div
            className={`bg-white rounded-3xl border-2 border-[#F5E6D3] overflow-hidden ${
              selectedOrder ? "flex-1 hidden lg:block" : "w-full"
            }`}
          >
                ...
                <tbody>
                  {paginated.length === 0 ? (
                    <tr>
                      <td
                        colSpan={6}
                        className="text-center py-10 text-[#8B4513]/50"
                      >
                        No orders found.
                      </td>
                    </tr>
                    ...
                    paginated.map((order) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-5 py-4 font-mono text-sm font-bold text-[#D4956A]">
                            {order.reference}
                          </td>
                          ...
                          <td className="px-5 py-4 hidden md:table-cell font-bold text-[#3C1810]">
            ...
            >
              ...
              <div className="space-y-2 mb-4 text-sm">
                ...
                <div className="flex gap-2">
                  ...
                  <span className="font-medium text-[#3C1810] text-xs truncate">
                ...
                <div className="flex gap-2">
                  ...
                  <span className="font-display text-lg text-[#D4956A]">
